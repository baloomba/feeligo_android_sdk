    ...
    public void updateStickerPack() {
        getRecentStickers(new WSStringResponseListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                fr.baloomba.feeligo.helper.FeeligoLog.log(fr.baloomba.feeligo.helper.FeeligoLog.ERROR, TAG, "getRecentStickers.onErrorResponse:" +
                        error.getMessage());
            }
        });
        getPopularStickers(new WSStringResponseListener() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                fr.baloomba.feeligo.helper.FeeligoLog.log(fr.baloomba.feeligo.helper.FeeligoLog.ERROR, TAG, "getPopularStickers.onErrorResponse:" +
                        error.getMessage());
            }
        });
        getUserStickerPack(new WSStringResponseListener() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                fr.baloomba.feeligo.helper.FeeligoLog.log(fr.baloomba.feeligo.helper.FeeligoLog.ERROR, TAG, "getUserStickerPack.onErrorResponse:" +
                        error.getMessage());
            }
        });
    }
